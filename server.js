...
const { seedAnglais } = require('./database/seed-anglais');
const { seedCulture } = require('./database/seed-culture');
const { seedArts } = require('./database/seed-arts');
const { seedInformatique } = require('./database/seed-informatique');
